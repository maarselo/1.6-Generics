...
public class Main {
    public static void main(String []args) {
        ...
        GenericMethods.printArguments(person1.getName(), person2.getAge(), 13.24);
        System.out.println("Second print arguments:");
        GenericMethods.printArguments("How are you?", person1.getAge(), person2.getClass().getSimpleName());
    }
}
